...
A summary of finished downloads can be found in `copinicoos_logs\WorkerManager.log`. You can check the download status (`SUCCESS`, `FAIL` or `OFFLINE`) of each product in this log file.
